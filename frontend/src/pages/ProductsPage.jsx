...
const ProductsPage = () => {
  ...
  }, [selectedCategory, inStock, onSale, searchTerm, sortOption, page, priceRange, navigate]);
  
  // For development - sample data
  // Remove this when backend is connected
  useEffect(() => {
    if (process.env.NODE_ENV === 'development') {
      const sampleCategories = ['Electronics', 'Clothing', 'Home & Garden', 'Beauty & Health', 'Sports', 'Toys', 'Books', 'Automotive'];
      setCategories(sampleCategories);
      
      const sampleProducts = Array(12).fill().map((_, idx) => ({
        _id: idx.toString(),
        name: `Product ${idx + 1}`,
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 rounded"
                      />
                      <label htmlFor="mobile-on-sale" className="ml-2 text-sm text-gray-700">
                        On Sale
                      </label>
                    </div>
                  </div>
        ...
        <div className="md:col-span-3">
          ...
          {/* Active Filters */}
          {(selectedCategory || inStock || onSale || priceRange.min || priceRange.max || searchTerm) && (
            <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
