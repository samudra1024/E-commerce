...
const HomePage = () => {
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === 'development') {
      ...
      setNewArrivals([...sampleProducts, ...sampleProducts].slice(0, 8));
      setLoading(false);
    }
  }, []);
    ...
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl opacity-90 max-w-lg">
                Discover a wide range of quality products with fast shipping and excellent customer service.
              </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-center">Top Categories</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <Link to="/products?category=electronics" className="group">
              <div className="bg-blue-100 rounded-xl p-6 text-center hover:bg-blue-200 transition-colors duration-200">
                ...
                <h3 className="font-semibold text-lg group-hover:text-blue-700 transition-colors">Electronics</h3>
              </div>
            </Link>
            <Link to="/products?category=clothing" className="group">
              <div className="bg-teal-100 rounded-xl p-6 text-center hover:bg-teal-200 transition-colors duration-200">
                ...
                <h3 className="font-semibold text-lg group-hover:text-teal-700 transition-colors">Clothing</h3>
              </div>
            </Link>
            <Link to="/products?category=home" className="group">
              <div className="bg-amber-100 rounded-xl p-6 text-center hover:bg-amber-200 transition-colors duration-200">
                ...
                <h3 className="font-semibold text-lg group-hover:text-amber-700 transition-colors">Home & Garden</h3>
              </div>
            </Link>
            <Link to="/products?category=beauty" className="group">
              <div className="bg-purple-100 rounded-xl p-6 text-center hover:bg-purple-200 transition-colors duration-200">
                ...
                <h3 className="font-semibold text-lg group-hover:text-purple-700 transition-colors">Beauty & Health</h3>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-50 rounded-xl my-8">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/products?featured=true" className="text-blue-600 hover:text-blue-800 flex items-center transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">On orders over $100. Get your products delivered to your doorstep for free.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">All transactions are processed securely through trusted payment gateways.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Not satisfied? Return any product within 30 days for a full refund.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm text-center hover:shadow-md transition-shadow">
              <div className="w-16 h-16 mx-auto bg-purple-100 rounded-full flex items-center justify-center mb-4">
                <CreditCard className="h-8 w-8 text-purple-600" />
              </div>
              <h3 className="font-semibold text-lg mb-2">Multiple Payment Options</h3>
              <p className="text-gray-600">Choose from various payment methods including credit cards and PayPal.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/products?sort=createdAt" className="text-blue-600 hover:text-blue-800 flex items-center transition-colors">
              View All <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
          <ProductList products={newArrivals} loading={loading} error={error} />
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl my-8 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-6 opacity-90">Get updates on new products, exclusive offers, and discounts directly to your inbox.</p>
